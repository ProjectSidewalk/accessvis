...
$TEST_HOSTNAME = 'accessscore-test.cs.washington.edu'; //The FQDN of the test server
$PROD_HOSTNAME = 'accessscore.cs.washington.edu'; //The FQDN of the production server
...
$CONTAINER_NAME = array(''); //A unique name for your container, comma separated, quotes list for multiple containers
