...
if ($_SERVER['HTTP_HOST'] == $TEST_HOSTNAME && $_SERVER['REQUEST_URI'] == $TEST_PATH."auto-deploy/"){
	$HOSTNAME=$TEST_HOSTNAME;
	$OPERATION=$TEST_MODE;
}
if ($_SERVER['HTTP_HOST'] == $PROD_HOSTNAME && $_SERVER['REQUEST_URI'] == $PROD_PATH."auto-deploy/"){
